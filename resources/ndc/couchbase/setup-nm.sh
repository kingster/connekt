...
echo "deb http://10.47.2.22:80/repos/couchbase4/1 /" | sudo tee /etc/apt/sources.list.d/fk-couchbase.list

sudo apt-get update
sudo apt-get install --yes --allow-unauthenticated couchbase-server-community
