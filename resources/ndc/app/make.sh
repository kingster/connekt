...
#kloud-cli --endpoint 10.33.65.0 --user connekt-dev  instance destroy --appId fk-connekt --instanceId 393258

#kloud-cli --endpoint 10.33.65.0  --user connekt-dev instance describe --appId fk-connekt --instanceId 393258
...
# kloud-cli --endpoint ga instanceTemplate create --appId fk-connekt --name aleph --type c1.xlarge --users  /home/kinshuk.bairagi/users.txt --script  /home/kinshuk.bairagi/connekt/setup.sh
